...
<head>
    ...
    <meta name="description" content="UK HR CLOUD">
    <meta name="keywords" content="UK HR CLOUD, visa , visa partner">
    <meta name="author" content="Afroza Prova">
                            ...
                            <tr>
                                <td width="100%">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td>
                                                <table width="100%" cellpadding="0" cellspacing="0" style="width:100%; max-width:600px; padding:20px; border:10px solid #2a2e6a;" align="center">
                                                    <tr>
                                                        <td role="modules-container" style="padding:0px 0px 0px 0px; color:#000000; text-align:left;" bgcolor="#FFFFFF" width="100%" align="left">
                                                            <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="6d47442c-9204-4e85-80be-ade744672b62" data-mc-module-version="2019-10-22">
                                                                <tbody>
                                                                    <tr>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12 col-lg-10 mx-auto">
                                                                                            <div class="card">
                                                                                                <div class="card-body">
                                                                                                    <div class="row">
                                                                                                        <div class="col-lg-12"> <img src="{{asset('/assets/images/HRMS.png')}}" alt="" class="img-flu" wth="200">
                                                                                                        ...
                                                                                                        <div class="col-md-12">
                                                                                                            <div class="float-left">
                                                                                                                <address>
                                                                                                                    ...
                                                                                                                    @if($employee->nationality){{$employee->nationality}}@endif
                                                                                                                    <p> Date: {{Carbon\Carbon::today() }}</p>
                                                                                                                    <strong> Subject: Right to Work Documentation – Temporary Visa 90-day Reminder.</strong>
                                                                                                                </address>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row">
                                                                                                        <div class="col-lg-12">
                                                                                                            ...
                                                                                                            <p> Further to your employment on a temporary visa, I am writing to remind you that this visa is due to expire on {{$employee->expiry_date}}. You are therefore requested to make arrangements to renew your right to work documentation in order for you to remain in employment.</p>
                                                                                                            ...
                                                                                                            <p> Organization will complete a check with the Home Office Employer Checking Service to obtain confirmation of any application at the time of your visa expiring or at 5 monthly intervals dependent on the checking requirements for the right to work documents you provide to us. Where a negative verification notice is received, we cannot continue to employ you, unless you are able to provide alternative evidence to satisfy us that you have the right to work.</p>
                                                            ...
                                                            <table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed; padding-top: 50px;" data-muid="288b2aae-07f9-4a23-9832-8aa3cbe838b9">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 0px 0px;" role="module-content" height="100%" valign="top" bgcolor="">
                                                                            <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="1px" style="line-height:1px; font-size:1px;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:0px 0px 1px 0px;" bgcolor="#989898"></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                            ...
                                                            <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed; " data-muid="1cfcdf54-8451-4960-9b9e-599d21766779" data-mc-module-version="2019-10-22">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:5px 0px 5px 0px; line-height:16px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                                                            <div>
