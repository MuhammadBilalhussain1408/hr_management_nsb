            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => ['hrm.emp_update', $employee->id],'method'=>'POST', 'id'=>'regForm',
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-border-bottom"  id="employee_type_id"
                                                ...
                                                <option value="{{$employee->employee_type_id}}" selected>{{$emptypes->where('id',$employee->employee_type_id)->first()->pluck('name')->first()}}</option>
                                               @endif
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="emg_name" type="text" class="form-control input-border-bottom"  value="{{$employee->emp_econ->emg_name}}"
                                            name="emg_name">
                                            <input id="emg_id" type="hidden" class="form-control input-border-bottom"  value="{{$employee->emp_econ->id}}"
                                            name="emg_id">
                                    </div>
