        ...
        <div class="row">
            <div class="col-md-12 col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12"> <img src="{{asset('/assets/images/UK HR CLOUD.png')}}" alt=""
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="text-center">{{$org->company_name}} </h2>
                                <h4 class="text-center">{{$org->address}} </h4>
                                <h4 class="text-center"> Employee Report</h4>
                            </div>
                            <div class="col-md-12">
                                <div class="float-left">
                                    <address>
                                        <strong>Employee Code: HR{{$employee->id}} </strong><br>
                                        Department:{{$employee->department->name}}
                                    </address>
                                </div>
                                <div class="float-right text-right">
                                    <address>
                                        <img class="img-responsive col-md-6" src="{{asset('/storage/upload/image/'.$employee->image)}}"><br>
                                        <strong class="font-14">Employee Name: {{$employee->fname}} {{$employee->m_name}} {{$employee->lname}}</strong><br>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>Employee Name</td>
                                                <td> {{$employee->fname}} {{$employee->m_name}} {{$employee->lname}}</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>Employee Code</td>
