            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::model($invoice, ['method' => 'PATCH','route' => ['hrm.invoices.update',
                        $invoice->id], 'files' => true, 'enctype' =>'multipart/form-data']) !!}
                        <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <optgroup label="Current">
                                            <option value="{{$invoice->organization_id}}">
                                                {{$invoice->org->company_name}}</option>
                                        </optgroup>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-border-bottom" id="service_id" required=""
                                        name="service_id" onchange="chngdepartmentdesp(this.value);">
                                        <optgroup label="Current">
                                            <option value="{{$invoice->body}}">
                                                {{$invoice->body}}</option>
                                        </optgroup>
                                        <optgroup>
                            ...
                            <div class="col-md-6">
                                <div class=" form-group">
                                    ...
                                    <input id="amount" type="text" class="form-control input-border-bottom" name="amount" value="{{$invoice->amount}}">
                            ...
                            <div class="col-md-6">
                                <div class=" form-group">
                                    ...
                                    <input id="bill_date" type="date" class="form-control nput-border-bottom" name="bill_date" value="{{$invoice->bill_date}}">

                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class=" forim-group">
                                    <label for="details" class="placeholder"> Descriptions</label>
                                    <textarea rows="5" class="form-control" id="details" name="body">{{$invoice->body}} </textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Bank :</strong>
                                    <select class="form-control input-border-bottom" id="bank_id" name="bank_id" onchange="bankcode(this.value);">
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-6">
                                <div class=" form-group">
                                    ...
                                    <select class="form-control input-border-bottom" id="bank_code" required="" name="bank_code" onchange="bankcode(this.value);">
                                        <option value="{{$invoice->bank_code}}">{{$invoice->bank_code}}</option>
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-6">
                                <div class=" form-group">
                                    ...
                                    <input id="account_no" type="text" class="form-control input-border-bottom" name="account_no" value="{{$invoice->account_no}}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-border-bottom" id="status" required="" name="status">
                                        <option value="{{ $invoice->status }}" @selected(old('status')==$invoice->status)>
                                            {{ $invoice->status }}
                                        </option>
