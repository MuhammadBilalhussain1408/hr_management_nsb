...
<div class="page-content">
    <div class="container-fluid">
        <!-- Page-Title -->
        @can('HolidayType-create')
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{('/holiday_types')}}">holiday_types</a></li>
                            <li class="breadcrumb-item active">Create New holiday_type </li>
                        </ol>
                    </div>
                    <h4 class="page-title"> Create New holiday_type </h4>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => 'hrm.holiday_types.store','method'=>'POST')) !!}
                        <div class="row">
