                            ...
                            <table id="datatable-buttons" data-order='[[ 1, "asc" ]]' data-page-length='20' class="table table-striped table-bordered w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-info" target="_blank" href="{{ asset('/storage/upload/resume/'.$jobapplied->resume) }}" download>resume</a>
                                        <a class="btn btn-info" target="_blank" href="{{ asset('/storage/upload/cover_letter/'.$jobapplied->cover_letter) }}" download>cover letter</a>
