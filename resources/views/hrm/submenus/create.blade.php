            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{('/submenus')}}">submenus</a></li>
                            <li class="breadcrumb-item active">Create New submenu </li>
                        </ol>
                    </div>
                    <h4 class="page-title"> Create New submenu </h4>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::open(array('route' => 'hrm.submenus.store','method'=>'POST', 'id'=>'regForm',
