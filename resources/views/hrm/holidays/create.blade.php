            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{('/holidays')}}">holiday</a></li>
                            <li class="breadcrumb-item active">Create New holiday </li>
                        </ol>
                    </div>
                    <h4 class="page-title"> Create New holiday </h4>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => 'hrm.holidays.store','method'=>'POST')) !!}
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <input id="to_date" type="date" class="form-control " name="to_date" required="" value="" onchange="calculateDays()" onclick="calculateDays()">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <input id="num_of_day" type="text" class="form-control " required="" name="num_of_day" value="" readonly="">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="body" type="text" class="form-control input-border-bottom" required="" name="body" value="">
