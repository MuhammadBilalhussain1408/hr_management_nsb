            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{('/hrm/right_works')}}">right_works</a></li>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => 'hrm.right_works.store','method'=>'POST', 'id'=>'regForm',
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-border-bottom" id="employee_id" name="employee_id" onchange="chngdepartment(this.value);">
                                                <option value="">&nbsp;</option>
                                                @forelse ($datas['employees'] as $key => $emp)
                                                <option value="{{$emp->id}}">{{$emp->fname}} {{$emp->mid_name}}
                                                    {{$emp->lname}}
                                                </option>
                                                @empty
                                                @endforelse
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="start_date" type="date" class="form-control input-border-bottom" name="start_date">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="check_date" type="date" class="form-control input-border-bottom" name="check_date">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="employee_id" class="placeholder">Name of person </label>
                                        <input class="form-control" id="employee_idnew" type="text" name="employee_idnew" required="" disabled="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="start_date_new" class="placeholder">Work start date</label>
                                        <input id="start_date_new" type="date" class="form-control" name="start_date_new">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="gender" name="checkmidia_id[]" value="{{$midia->id}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="employee_id" class="placeholder">Evidence presented </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="check_time" type="text" class="form-control input-border-bottom" name="check_time">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input id="list_group1_date" type="date" class="form-control" name="list_group1_date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-4">List B: Group 2</label>
                                        <div class="col-md-8">
                                            <input id="list_group2_date" type="date" class="form-control" name="list_group2_date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-4"> EUSS </label>
                                        <div class="col-md-8">
                                            <input id="list_euss_date" type="date" class="form-control" name="list_euss_date">
                                        </div>
                                    </div>
                            ...
                            <!-- <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="employee_id" class="control-label">Select Document </label>
                                        <select class="form-control input-border-bottom" id="scan_doc2" name="scan_doc2" onchange="checkscan2(this.value);">
                                            <option value="">&nbsp;</option>
                                            <option value="image">Passport Document</option>
                                            <option value="pr_add_proof">Proof Of Correspondence Address</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="check_time" class="placeholder">RTW Evidence Scans-1</label>
                                        <div class="scan-body" style="background: #edecec;">

                                            <img name="imgeid" id="imgeid" width="50%" src="/public/upload/pr_add_proof/qZSsexeRjt4OUY0e8GW7vcS126Jd3QQWaIUMG7Rl.pdf">
                                            <div id="scan_ne_id" style="display:none;margin-top:20px;">
                                                <img name="imgeidnew" id="imgeidnew" width="50%">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="check_name" required="" value="{{$organization->f_name}} {{$organization->l_name}}">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="con_number" type="text" class="form-control" name="check_phone" value="{{$organization->con_num}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="designation" type="text" class="form-control" name="check_designation" value="{{$organization->designation}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="email" class="placeholder">Email Address</label>
                                        <input id="email" type="email" class="form-control" name="check_email" value="{{$organization->authemail}}">
                                    </div>
                                </div>
                            </div>
                        </div>
