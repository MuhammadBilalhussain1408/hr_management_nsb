                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create New Duty Roster </li>
                        </ol>
                    </div>
                    <h4 class="page-title"> Create New Duty Roster </h4>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => 'hrm.duty_rosters.store','method'=>'POST')) !!}
