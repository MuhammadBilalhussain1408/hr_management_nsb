    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{('/hrm/banks')}}">banks</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary" href="{{ route('hrm.banks.index') }}"> Back</a>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        {!! Form::model($bank, ['method' => 'PATCH','route' => ['hrm.banks.update',
                        $bank->id]]) !!}
                        <div class="row">
